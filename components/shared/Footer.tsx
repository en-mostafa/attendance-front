    ...
    return (
        <footer className="bottom-0 w-full left-0 right-0 fixed z-1000 mx-auto">
            <ul className="bg-primary h-[70px] rounded-[96px] p-4 mx-6 mb-7 flex justify-between items-center">
                <li>
                    <Link href="/" className="flex items-center bg-destructive px-3 py-1 gap-x-1 rounded-full">
                ...
                <li>
                    <Link href="/wallet" className="flex items-center px-3 py-1 gap-x-1 rounded-full mr-3">
                        <span className="mt-1 text-background hidden">Wallet</span>
                        <BiSolidWallet className="text-2xl text-background" />
                    </Link>
                </li>
                <li>
                    <Link href="/dashboard" className="flex items-center px-3 py-1 gap-x-1 rounded-full mr-3">
                ...
                <li>
                    <Link href="/history" className="flex items-center px-3 py-1 gap-x-1 rounded-full">

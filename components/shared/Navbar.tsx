...
import { BiChevronsDown, BiUser, BiMessageDetail, BiArrowBack, BiTransferAlt } from "react-icons/bi";
import Logout from "../pages/logout/Logout";

export default function Navbar({ showMenu, setShowMenu } : { showMenu: boolean, setShowMenu: (showMenu: boolean) => void }) {

        ...
        <>
            <div className="flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-4 p-3">
                    ...
                    <Link href={`/leave/details?date=${today}`} className="bg-card flex flex-col items-center justify-center py-5 px-10 rounded-lg border-2">
                        <div className="w-16 h-16 rounded-[20px] bg-[#FFF2F2] flex items-center justify-center">
                            <Image
                                src={SVG5}
                                alt="svg"
                    ...
                    <Link href="/notification" className="bg-card flex flex-col items-center justify-center py-5 px-10 rounded-lg border-2">
                        <div className="w-16 h-16 rounded-[20px] bg-[#FFF2F2] flex items-center justify-center">

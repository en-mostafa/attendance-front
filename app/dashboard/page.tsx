        ...
        <>
            <div className="flex flex-col">
                ...
                <ul className="grid grid-cols-2 gap-4 p-3">
                    <li className="bg-card flex flex-col items-center justify-center py-5 px-10 rounded-lg border-2">
